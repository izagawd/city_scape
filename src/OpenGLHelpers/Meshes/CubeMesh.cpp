...
void CubeMesh::setMeshData(std::array<unsigned char, 36> &indices, std::array<Vertex3D, 24> &triangleVertices,
    std::array<TextCoord, 24> &textCoords) {
        // Define the 24 unique vertices
    // Front face (Vertices 0-3)
    triangleVertices[0] = Vertex3D(-1, -1, 1);  // Bottom-left
    triangleVertices[1] = Vertex3D(1, -1, 1);   // Bottom-right
    triangleVertices[2] = Vertex3D(1, 1, 1);   // Top-right
    triangleVertices[3] = Vertex3D(-1, 1, 1);  // Top-left
    ...
    triangleVertices[4] = Vertex3D(1, -1, -1);   // Bottom-left
    triangleVertices[5] = Vertex3D(-1, -1, -1);  // Bottom-right
    triangleVertices[6] = Vertex3D(-1, 1, -1);  // Top-right
    triangleVertices[7] = Vertex3D(1, 1, -1);   // Top-left
    ...
    triangleVertices[8]  = Vertex3D(-1, -1, -1); // Bottom-left
    triangleVertices[9]  = Vertex3D(-1, -1, 1);  // Bottom-right
    triangleVertices[10] = Vertex3D(-1, 1, 1);  // Top-right
    triangleVertices[11] = Vertex3D(-1, 1, -1); // Top-left
    ...
    triangleVertices[12] = Vertex3D(1, -1, 1);   // Bottom-left
    triangleVertices[13] = Vertex3D(1, -1, -1);  // Bottom-right
    triangleVertices[14] = Vertex3D(1, 1, -1);  // Top-right
    triangleVertices[15] = Vertex3D(1, 1, 1);   // Top-left
    ...
    triangleVertices[16] = Vertex3D(-1, 1, 1);  // Bottom-left
    triangleVertices[17] = Vertex3D(1, 1, 1);   // Bottom-right
    triangleVertices[18] = Vertex3D(1, 1, -1);  // Top-right
    triangleVertices[19] = Vertex3D(-1, 1, -1); // Top-left
    ...
    triangleVertices[20] = Vertex3D(-1, -1, -1); // Bottom-left
    triangleVertices[21] = Vertex3D(1, -1, -1);  // Bottom-right
    triangleVertices[22] = Vertex3D(1, -1, 1);   // Top-right
    triangleVertices[23] = Vertex3D(-1, -1, 1);  // Top-left
